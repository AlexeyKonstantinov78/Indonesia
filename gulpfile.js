...
const path = {
	...
	src: {
		...
		assets: ['src/fonts/**/*.*', 'src/icons/**/*.*', 'src/video/**/*.*', 'src/public/**/*.*', 'src/favicons/**/*.*',] // 'src/robots.txt', 'src/site.webmanifest', 'src/sitemap.xml',
	},
	watch: {
		html: 'src/*.html',
		js: 'src/**/*.js',
...
// favicon запускаем один раз

export const favicon = () => gulp
    .src('src/favicon.png')
    .pipe(
        favicons({
            appName: 'My App',
